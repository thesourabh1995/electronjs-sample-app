...
module.exports = {
  ...
  packagerConfig: {
    ...
    appCopyright: 'Copyright (C) 2021 Sourabh Mishra',
  ...
  plugins: [
    {
      ...
      config: {
        ...
        devContentSecurityPolicy: `default-src 'self' 'unsafe-inline' data:; script-src 'self' 'unsafe-inline' data:; connect-src 'self' https://jsonplaceholder.typicode.com; img-src 'self' data: https://via.placeholder.com`,
        // Ports
